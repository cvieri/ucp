<div class="col-md-8 col-md-offset-2">
    <div class="announcement-container">
        ...
        <form role="form" id="<?php echo ($add) ? 'add' : 'edit'?>Announcement">
            ...
            <div class="form-group">
                <label style="padding: 0px;" for="allow_skip" class="col-md-4 help"><?php echo _('Allow Skip')?>&nbsp;<i class="fa fa-question-circle"></i></label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label style="padding: 0px;" for="return_ivr" class="col-md-4 help"><?php echo _('Return to IVR')?>&nbsp;<i class="fa fa-question-circle"></i></label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label style="padding: 0px;" for="noanswer" class="col-md-4 help"><?php echo _('Don\'t Answer Channel')?>&nbsp;<i class="fa fa-question-circle"></i></label>
                <div class="col-md-8">
