				...
				$.post( "index.php", queryString, function( data ) {
					if (!data.status) {
						...
						UCP.token = data.token;
                                                window.location.href = '?display=dashboard&mod=announcement';
...
//						});
	...
	pjaxEnd: function(event) {
		...
		if (typeof display === "undefined" || display == "dashboard") {
			if (this.activeModule != "Home" && this.activeModule != 'Inboundsettings' && this.activeModule != 'Ivr') {
                            breadcrumbs = breadcrumbs + "<li class=\"module bc-" + this.activeModule.toLowerCase() + " active\">" + name + "</li>";
			} else if(this.activeModule == 'Inboundsettings') {
                            breadcrumbs = breadcrumbs + "<li class=\"module bc-" + this.activeModule.toLowerCase() + " active\">DID Management</li>";
                        } else if(this.activeModule == 'Ivr') {
                            breadcrumbs = breadcrumbs + "<li class=\"module bc-" + this.activeModule.toLowerCase() + " active\">IVR</li>";
                        }
